        ...
        <div className="flex h-full">
                ...
                <div className="overflow-y-auto flex-1">
                    ...
                    <div className="flex items-center p-2 bg-white rounded mb-2 hover:bg-gray-200 cursor-pointer">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-500">Another message preview...</div>
                        </div>
                    </div>
            ...
            <div className="w-2/3 bg-white p-4 flex flex-col">
                ...
                <div className="overflow-y-auto flex-1 bg-gray-50 p-4 rounded">
                    {/* Chat message */}
                    <div className="mb-4">
                        <div className="bg-blue-500 text-white p-2 rounded-md mb-2">Hi, how are you?</div>
                        <div className="bg-gray-300 p-2 rounded-md">I'm good, how about you?</div>
                    </div>
