	...
	return (
		<div className="fixed w-screen h-screen top-0 left-0 bg-black/40 z-50 pt-8 md:pt-0">
			<div className="w-full h-full relative flex justify-center items-center">
				<button onClick={()=> setVisible(false)} className="absolute top-5 right-5 z-50">
					<XMarkIcon className="w-7 h-7 text-white" />
			    </button>

                <div className="w-96 h-[450px] black rounded-lg bg-gray-900 text-white flex flex-col">
                    <span className="flex justify-center font-semibold py-2">Create new post</span>
                    <div className="w-full h-[1px] bg-gray-700"></div>

                    <div className="flex flex-col justify-center items-center flex-1">
                        <img src={illustration} alt="" className="w-28 h-auto" />
